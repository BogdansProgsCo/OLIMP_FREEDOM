...
url = 'https://nb-bet.com/Teams/1204-Adelaida-Yunayted-statistika-komandi'
...
def draws(x):
    ...
    for i in x:
        if (i == '0 : 0 ' or i == '1 : 1 ' or i == '2 : 2 ' or i == '3 : 3 ' or i == '4 : 4 '
            ...
            break
    if count >= draw:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m ничей = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
        new_file.write('\n draws = ' + b)
        new_file.close()
...
def odd(x):
    ...
    if count >= odd_even:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m не-чет = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
        new_file.write('\n odd = ' + b)
        new_file.close()
...
def even(x):
    ...
    if count >= odd_even:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m чет = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
        new_file.write('\n even = ' + b)
        new_file.close()
...
def under_1_5(x):
    ...
    if count >= under_15:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m мен 1.5 = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
        new_file.write('\n under_1.5 = ' + b)
        new_file.close()
...
def over_2_5(x):
    ...
    if count >= over_25:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m бол 2.5 = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
        new_file.write('\n over_2.5 = ' + b)
        new_file.close()
...
def under_2_5(x):
    ...
    if count >= under_25:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m мен 2.5 = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
        new_file.write('\n under_2.5 = ' + b)
        new_file.close()
...
def both_score(x):
    ...
    if count >= both_scores:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m обе зибили = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
        new_file.write('\n both_score = ' + b)
        new_file.close()
...
def both_no_score(x):
    ...
    if count >= both_scores:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m обе НЕ зибили = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
        new_file.write('\n both_no_score = ' + b)
        new_file.close()
...
def draws_first_time(x):
    ...
    if count >= drw_frst_tm:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m ничьи 1-й тайм = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
        new_file.write('\n draws_first_time = ' + b)
        new_file.close()
...
def no_goal_first_time(x):
    ...
    if count >= no_goal_frst_tm:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m 0:0  1-й тайм = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
...
def Odd_Even(x):
    ...
    if count >= od_ev:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m НЕчет_чет = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
        new_file.write('\n odd_even = ' + b)
        new_file.close()
...
def Even_Odd(x):
    ...
    if count >= ev_od:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m чет_НЕчет = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
        new_file.write('\n even_odd = ' + b)
        new_file.close()
...
def draws_NOdraws(x):
    ...
    if count >= drw_NOdrw:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m ничья_НЕничья = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
        new_file.write('\n draws_NOdraws = ' + b)
        new_file.close()
...
def NOdraws_draws(x):
    ...
    if count >= NOdrw_drw:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m НЕничья_ничья = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
        new_file.write('\n NOdraws_draws = ' + b)
        new_file.close()
...
def under15_over15(x):
    ...
    if count >= und15_ovr15:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m мен_бол 1.5 = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
        new_file.write('\n under_over 1.5 = ' + b)
        new_file.close()
...
def over15_under15(x):
    ...
    if count >= ovr15_und15:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m бол_мен 1.5 = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
        new_file.write('\n over_under 1.5 = ' + b)
        new_file.close()
...
def under25_over25(x):
    ...
    if count >= und25_ovr25:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m мен_бол 2.5 = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
        new_file.write('\n under_over 2.5 = ' + b)
        new_file.close()
...
def over25_under25(x):
    ...
    if count >= ovr25_und25:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m бол_мен 2.5 = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
        new_file.write('\n over_under 2.5 = ' + b)
        new_file.close()
...
def both_noboth_score(x):
    ...
    if count >= both_noboth:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m обе_необе забили = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
        new_file.write('\n both_noboth score = ' + b)
        new_file.close()
...
def noboth_both_score(x):
    ...
    if count >= noboth_both:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m необе_обе забили = {count} \033[0m')
        print(' ')
        b = str(count)
        new_file = open(a, "a+")
        new_file.write('\n noboth_both score = ' + b)
...
def draws_NOdraws_first_time(x):
    ...
    if count >= drw_NOdrw_ft:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m ничья_НЕничья 1-й тайм = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
...
def NOdraws_draws_first_time(x):
    ...
    if count >= NOdrw_drw_ft:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m НЕничья_ничья 1-й тайм = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
...
def goal_NOgoal_first_time(x):
    ...
    if count >= goal_NOgoal_ft:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m гол-НЕгол 1-й тайм = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
...
def NOgoal_goal_first_time(x):
    ...
    if count >= NOgoal_goal_ft:
        print(f'\033[1;34m{next_game_3}\033[1;35m ({next_games_1})  \033[1;36m {champ:7} '
              f'\033[1;33m {team :12} \033[1;31m НЕгол_гол 1-й тайм = {count} \033[0m')
        b = str(count)
        new_file = open(a, "a+")
...
url = 'https://nb-bet.com/Teams/1205-Brisben-Roar-statistika-komandi'
...
url = 'https://nb-bet.com/Teams/1212-Sentral-Kost-Mariners-statistika-komandi'
...
url = 'https://nb-bet.com/Teams/4564-Makartur-statistika-komandi'
...
url = 'https://nb-bet.com/Teams/1209-Melburn-Siti-statistika-komandi'
...
url = 'https://nb-bet.com/Teams/1208-Melburn-Viktori-statistika-komandi'
...
url = 'https://nb-bet.com/Teams/1210-Nyukasl-Dzhets-statistika-komandi'
...
url = 'https://nb-bet.com/Teams/1211-Pert-Glori-statistika-komandi'
...
url = 'https://nb-bet.com/Teams/1213-Sidney-statistika-komandi'
...
url = 'https://nb-bet.com/Teams/1206-Vellington-Finiks-statistika-komandi'
...
url = 'https://nb-bet.com/Teams/1207-Sidney-Uonderers-statistika-komandi'
...
url = 'https://nb-bet.com/Teams/3994-Vestern-Yunayted-statistika-komandi'
