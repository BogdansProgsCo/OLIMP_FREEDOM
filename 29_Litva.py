...
url = 'https://nb-bet.com/Teams/988-Suduva-statistika-komandi'
...
url = 'https://nb-bet.com/Teams/1127-Kauno-Zhalgiris-statistika-komandi'

team = "Кауно Жальгирис"
...
url = 'https://nb-bet.com/Teams/928-Zhalgiris-statistika-komandi'
...
url = 'https://nb-bet.com/Teams/3451-Panevezhis-statistika-komandi'
...
url = 'https://nb-bet.com/Teams/4263-Khegelmann-Litauen-statistika-komandi'

team = "Хегельман Литауэн"

def adding_team():
    b = "Khegelmann-Litauen"
    new_file = open(a, "a+")
    new_file.write('\n\n --------------------------------- ' + b)
    new_file.close()
...
url = 'https://nb-bet.com/Teams/990-Trakay-statistika-komandi'
...
url = 'https://nb-bet.com/Teams/4258-Dzhyugas-Telshyay-statistika-komandi'
...
url = 'https://nb-bet.com/Teams/4260-Daynava-Alitus-statistika-komandi'
...
url = 'https://nb-bet.com/Teams/1017-Banga-statistika-komandi'
...
url = 'https://nb-bet.com/Teams/4261-Nevezhis-Kedaynyay-statistika-komandi'

team = "Невежис Кедайняй"

def adding_team():
    b = "Nevezhis-Kedaynyay"
    new_file = open(a, "a+")
    new_file.write('\n\n --------------------------------- ' + b)
    new_file.close()
